...
│「 Hi Cutie🌝 」
└┬❖ 「 ${pushname} 」
┌┤✑  HI CUTIE 💖 I AM DOGESH BOT READY FOR YOUR HELP PLEASE SELECT THE BUTTONS BElOW IF YOU WANT TO ADD BOT IN YOUR GROUP CONTACT OWNER 
│└────────────┈ ⳹
│
└─「 𝘽𝙊𝙏 𝙄𝙉𝙁𝙊 」       
  ...
  let buttons = [
      {
       ...
       buttonText: {
        displayText: 'Mine Again Cutie⛏️'
      }, type: 1},
    ]
    let buttonMessage = {
...
mediaType:1,
mediaUrl: 'https://i.ibb.co/0KpXdQD/IMG-20220708-WA0001.jpg',
sourceUrl: "https://i.ibb.co/0KpXdQD/IMG-20220708-WA0001.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
